...
# 脚本名称: install.sh
# 脚本仓库: https://github.com/AnonymousFamily/Xray-script
...
#
# Copyright (C) 2025 AnonymousFamily
# =============================================================================
...
function download_xray_script_files() {
    ...
    local script_github_api="https://api.github.com/repos/AnonymousFamily/xray-script/tarball/main"
...
function check_xray_script_version() {
    ...
    local script_config_github_url="https://raw.githubusercontent.com/AnonymousFamily/Xray-script/main/config.json"
...
function main() {
    ...
    if [[ ! -d "${SCRIPT_CONFIG_DIR}" && ! -f "${SCRIPT_CONFIG_PATH}" ]]; then
        ...
        wget -O "${SCRIPT_CONFIG_PATH}" https://raw.githubusercontent.com/AnonymousFamily/Xray-script/main/config.json
    fi
