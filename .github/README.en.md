...
* Download:
  ```sh
  wget --no-check-certificate -O ${HOME}/Xray-script.sh https://raw.githubusercontent.com/AnonymousFamily/Xray-script/main/install.sh
  ```
...
* Quick start (with interface)
  ```sh
  wget --no-check-certificate -O ${HOME}/Xray-script.sh https://raw.githubusercontent.com/AnonymousFamily/Xray-script/main/install.sh && bash ${HOME}/Xray-script.sh
  ```
...
Copyright (C) AnonymousFamily | https://github.com/AnonymousFamily/Xray-script
